    ...
    private function render_title_fields($index, $data) {
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <input type="text" class="fp-lp-field" data-field="text" value="<?php echo esc_attr($data['text'] ?? ''); ?>" style="width: 100%;" placeholder="Inserisci il titolo">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select class="fp-lp-field" data-field="level">
                        <option value="h1" <?php selected($data['level'] ?? 'h2', 'h1'); ?>>H1</option>
                        <option value="h2" <?php selected($data['level'] ?? 'h2', 'h2'); ?>>H2</option>
                        <option value="h3" <?php selected($data['level'] ?? 'h2', 'h3'); ?>>H3</option>
                        <option value="h4" <?php selected($data['level'] ?? 'h2', 'h4'); ?>>H4</option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select class="fp-lp-field" data-field="align">
                        <option value="left" <?php selected($data['align'] ?? 'left', 'left'); ?>>Sinistra</option>
                        <option value="center" <?php selected($data['align'] ?? 'left', 'center'); ?>>Centro</option>
                        <option value="right" <?php selected($data['align'] ?? 'left', 'right'); ?>>Destra</option>
                    </select>
                </td>
            </tr>
        </table>
            ...
            <tr>
                ...
                <td>
                    <select class="fp-lp-field" data-field="align">
                        ...
                        <option value="center" <?php selected($data['align'] ?? 'left', 'center'); ?>>Centro</option>
                        <option value="right" <?php selected($data['align'] ?? 'left', 'right'); ?>>Destra</option>
                        <option value="justify" <?php selected($data['align'] ?? 'left', 'justify'); ?>>Giustificato</option>
                    </select>
                </td>
            </tr>
        </table>
    ...
    private function render_image_fields($index, $data) {
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <select class="fp-lp-field" data-field="align">
                        <option value="left" <?php selected($data['align'] ?? 'center', 'left'); ?>>Sinistra</option>
                        <option value="center" <?php selected($data['align'] ?? 'center', 'center'); ?>>Centro</option>
                        <option value="right" <?php selected($data['align'] ?? 'center', 'right'); ?>>Destra</option>
                    </select>
                </td>
            </tr>
            <tr>
                                ...
                                <table style="width: 100%;">
                                    <tr>
                                        ...
                                        <td style="padding: 5px 0;">
                                            <input type="text" class="fp-lp-feature-field" data-field="icon" data-feature-index="<?php echo esc_attr($i); ?>" value="<?php echo esc_attr($feature['icon'] ?? ''); ?>" style="width: 100%;" placeholder="fa fa-star">
